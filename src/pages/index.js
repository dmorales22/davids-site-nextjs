...
export default function Home() {
  ...
  const name = "David Morales";
  const title = "Full Stack Developer - Software Engineer";
  const description =
    "This is my personal portfolio website to showcase some projects that I am working on, and my professional blog to document my career and progression of knowledge in the software industry. I also do freelance work (depending availability) if you or your organization is interested in contract work.";
  const gitHubLink = "https://github.com/dmorales22";
  const linkedInLink = "https://www.linkedin.com/in/david-morales22/";
        ...
        <div className="bg-gradient-to-r min-h-screen max-h-full from-purple-500 to-pink-500 relative isolate overflow-hidden bg-gray-900 py-12">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="p-2 mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
              <div className="justify-center grid grid-cols-1 gap-x-8 gap-y-6 text-base text-lg font-semibold leading-7 text-white sm:grid-cols-2 md:flex lg:gap-x-10">
                {links.map((link) => (
            ...
            <div className={"flex justify-center"}>
              <button aria-label="linkedin-button" className={"m-4"}>
                <a
              ...
              <button aria-label="github-button" className={"m-1"}>
                <a
                  aria-label="Link to my GitHub repos"
                  href={gitHubLink}
                  target="_blank"
                >
